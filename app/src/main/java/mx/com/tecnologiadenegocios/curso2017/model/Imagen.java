...
public class Imagen implements Serializable {
    public static final String TABLE_NAME = "FotoEmergencia";
    ...
    public static final String FIELD_ICVECONCEPTO = "icveConcepto";
    ...
    public Imagen(int icve, int icveEmergencia, String url, int ccve) {
        this.icve = icve;
